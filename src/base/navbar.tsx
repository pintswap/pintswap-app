...
import { MdAddCircleOutline, MdListAlt, MdOutlineAccountCircle } from 'react-icons/md'
...
export const Navbar = () => {
    ...
    const NAV_ITEMS = [
        { text: 'Open Orders', onClick: () => navigate('/open'), disabled: false, icon: <MdListAlt size={iconSize} /> },
        { text: 'Create', onClick: () => navigate('/create'), disabled: false, icon: <MdAddCircleOutline size={iconSize} /> },
